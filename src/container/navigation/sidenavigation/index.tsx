...
export const SideNavigation: React.FC<SideNavigationPropsType> = ({ avatar, username, role }) => {
    const navigate = useNavigate();
    const matchesMobileAndAbove = useMediaQuery('(min-width:425px)');
    const {
        setIsSideNavigationClosing, isMobileSideNavigationOpen, setIsMobileSideNavigationOpen

...
import { Box, IconButton, InputAdornment, Stack, Toolbar, Typography, useMediaQuery } from "@mui/material";
import { BaseInput } from "../../../component/form/input/styled";
import { NotificationIcon, SearchIcon } from "../../../asset";
import MenuIcon from '@mui/icons-material/Menu';
import { SideNavigationPropsType } from "../../../type/container.type";

export const TopNavigation: React.FC<SideNavigationPropsType> = ({ username, avatar, role }) => {
    const {
    ...
    const handleOpenNotification = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        e.preventDefault();
    };
    ...
    return (
        <TopNavigationWrapper>
            <Toolbar>
                ...
                <Stack
                    className="top-navigation-MS"
                >
                    <Box
                        component={"div"}
                        className="notification-button-box"
                    >
                        <IconButton
                            sx={{
                                color: "#FAF6F6",
                    ...
                    <Stack
                        className="logged-in-user-information-stack"
                    >
                        <Box>
                            <img
                                src={avatar}
